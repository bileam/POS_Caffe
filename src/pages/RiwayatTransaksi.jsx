...
const RiwayatTransaksi = () => {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden gap-2">
      ...
      <div className="flex-1 bg-white  p-3 flex  gap-2 overflow-hidden">
        <div className="overflow-y-auto min-w-100">
          {[...ListTransaksi]
            .sort((a, b) => b.id - a.id)
            .map((item) => (
              <button className="flex flex-col shadow-md hover:shadow-[#d4e7dc] p-2 rounded-md text-start w-100 cursor-pointer active:scale-95 transition-all duration-500 ease-in-out">
